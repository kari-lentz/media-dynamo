...
OBJECTS := video-player.o sdl-holder.o dom-context.o asset.o cairo-f.o video-decode-context.o audio-decode-context.o audio-silence-context.o render-video.o  
