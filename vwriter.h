...
vwriter(ring_buffer<T>* pbuffer, bool own_p = true):pbuffer_(pbuffer), own_p_(own_p),functor_(this, &vwriter<T>::call), src_buffer_(NULL), remaining_(0), eof_p_(false),error_p_(false)
  {
  }
